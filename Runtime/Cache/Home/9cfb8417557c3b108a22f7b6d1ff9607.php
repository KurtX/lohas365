...
<div id="main-container" class="admin_container">
  ...
  <style type="text/css">
    td{ font-size:14px;}
  	#phone{ position:relative; margin:0 0; width:400px; height:698px; background:url(/shop/Public/Home/images/preview_phone_short.jpg) no-repeat center 0;}
	...
	.wx_menu .keyboard{ float:left; width:44px;height:50px; background:url(/weiphp3.0/Public/Home/images/wx_menu_keyboard_icon.png) no-repeat; background-size:100% 100%; border-right:1px solid #CCC;}
	...
	.wx_menu .sub_menu em{ position:absolute; width:10px; height:8px; bottom:-7px; left:50%; margin-left:-5px; background:url(/weiphp3.0/Public/Home/images/arrow_down.png) no-repeat center bottom;}
  </style>
                	...
                	<div class="wx_menu">
                        ...
                        <div class="menu">
                        	 <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if(($data[pid]) == "0"): ?><div class="m_a"  href="javascript:;">
                                    	<div class="m_a_i">
                                       	  <img src="/weiphp3.0/Public/Home/images/wx_menu_list_icon.png"/><?php echo ($data["title"]); ?>
                                        </div>
                                        <div class="sub_menu">
