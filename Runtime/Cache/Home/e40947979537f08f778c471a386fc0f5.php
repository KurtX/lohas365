    ...
    <section id="contents"> 
      <div class="table-bar">
        ...
        <div class="search-form fr cf">
          <input type="text" placeholder="请输入标题搜索" value="<?php echo I('title');?>" class="search-input" name="title">
            ...
            <tbody>
              <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td>
                   ...
                   <td type="start_date"><?php echo (time_format($vo["start_date"])); ?></td>
                   <td type="end_date"><?php echo (time_format($vo["end_date"])); ?></td>
                   <td type="guess_count"><?php echo ($vo["guess_count"]); ?></td>
